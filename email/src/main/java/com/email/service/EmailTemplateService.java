...
import com.email.MailSettings;
import com.email.model.MailTemplate;
import com.email.model.MailTemplateInfo;
...
public interface EmailTemplateService {
    ...
    /**
     * Sends an email to a single email address, using the sender from {@link MailSettings}
     *
    ...
    /**
     * Sends an email to a collection of email addresses, using the sender from {@link MailSettings}
     *
    ...
    /**
     * Sends an email to the email addresses provided in the {@link com.email.model.MailInfo}, using the sender from the passed in {@link com.email.model.MailInfo},
     * or if not provided, the one in {@link MailSettings}.  Provides much more functionality than
     * either {@link #sendEmail(Collection, MailTemplate, Map)} or {@link #sendEmail(String, MailTemplate, Map)}
     *
     * Note if the body is provided in the {@link com.email.model.MailInfo} it will be overwritten by the result of rendering the {@link MailTemplate}.
     * Similarly if the subject is provided in the {@link com.email.model.MailInfo} it will be overwritten by the subject in the {@link MailTemplate}
     *
