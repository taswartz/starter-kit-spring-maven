 ...
 *     {@link com.email.service.Emailer} to specify more than the typical amount of
...
public class MailTemplateInfo implements Serializable {
     ...
     *     when used in conjunction with {@link com.email.service.EmailTemplateService#sendEmail(MailTemplateInfo)},
     *     if provided will override the sender from {@link MailSettings}
     * </p>
     *
     ...
     *     when used in conjunction with {@link com.email.service.Emailer#sendEmail(MailTemplateInfo)},
     *     if provided will override the sender from {@link MailSettings}
     * </p>
     *
